...
function Chat() {
    ...
    const [sampleQuestions] = useState([
        ...
        'Балам мектеп жиналысына қатыса ала ма?',
        'Мектеп формасы қандай болу керек?',
        'Мектеп ақысын қалай төлеуге болады?',
        'Баламның мінез-құлқы туралы не айтуға болады?',
        'Мектеп автобусының кестесі қандай?',
        'Қысқы демалыс қашан басталады?',
        'Балама қосымша сабақтарға қатысуға болады ма?',
        'Мектепке қатысу туралы мәліметті қайдан алуға болады?',
        'Ата-аналар жиналысы қашан болады?',
        'Мектептегі қосымша сабақтардың уақыты қандай?',
